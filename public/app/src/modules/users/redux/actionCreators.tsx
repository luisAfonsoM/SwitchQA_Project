...
function deletingUserFailure(error: string): UsersAction {
  return {
...
function gettingMemberDetails(result: any): UsersAction {
  return {
    type: actions.DELETING_USER,
    result
  };
...
function gettingMemberDetailsFailure(error: string): UsersAction {
  return {
    type: actions.DELETING_USER_FAILURE,
    error
  };
...
function gettingMemberDetailsSuccess(any: any): UsersAction {
  return {
    type: actions.DELETING_USER_SUCCESS
  };
}
...
export {
  ...
  gettingMemberDetailsFailure,
  gettingMemberDetailsSuccess
};

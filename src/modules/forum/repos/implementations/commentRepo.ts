...
export class CommentRepo implements ICommentRepo {
  ...
  /**
   * Function to check if a member has comments
   * @param memberId MemberId
   * @returns boolean
   */
  public async hasCommentsByMemberId(memberId: MemberId | string): Promise<boolean> {
    ...
    const commentsCount = await CommentModel.count(detailsQuery);

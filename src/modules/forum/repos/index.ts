...
import { Bootstrap } from './implementations/bootstrap';
...
const bootstrap = new Bootstrap(models);

export { memberRepo, postRepo, commentRepo, postVotesRepo, commentVotesRepo, bootstrap };

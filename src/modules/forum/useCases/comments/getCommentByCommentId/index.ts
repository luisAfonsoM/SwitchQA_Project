...
const getCommentByCommentId = new GetCommentByCommentId(commentRepo, memberRepo);

const getCommentByCommentIdController = new GetCommentByCommentIdController(getCommentByCommentId);
